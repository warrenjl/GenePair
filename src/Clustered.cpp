...
arma::vec y = clustered_indicators;
...
Rcpp::List spatial_corr_info = spatial_corr_fun(m, 
                                                spatial_dists,
                                                phi(0));
neg_two_loglike(0) = neg_two_loglike_update_clust(y,
                                                  x_pair,
                                                  x_ind,
                                                  z, 
                                                  beta.col(0),
...
for(int j = 1; j < mcmc_samples; ++j){
   ...
   //omega Update
   Rcpp::List omega_output = omega_update_clust(y,
                                                x_pair,
                                                x_ind,
                                                z,
                                                n_star,
   ...
   neg_two_loglike(j) = neg_two_loglike_update_clust(y,
                                                     x_pair,
                                                     x_ind,
                                                     z, 
                                                     beta.col(j),
