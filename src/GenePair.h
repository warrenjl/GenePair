...
Rcpp::List Trans_Prob(int mcmc_samples,
                      ...
                      Rcpp::Nullable<double> a_sigma2_nu_z_prior,
                      Rcpp::Nullable<double> b_sigma2_nu_z_prior,
                      ...
                      Rcpp::Nullable<double> b_sigma2_nu_w_prior,
                      ...
                      Rcpp::Nullable<Rcpp::NumericVector> nu_z_init,
                      Rcpp::Nullable<double> sigma2_nu_z_init,
                      ...
                      Rcpp::Nullable<Rcpp::NumericVector> nu_w_init,
                      Rcpp::Nullable<double> sigma2_nu_w_init,
