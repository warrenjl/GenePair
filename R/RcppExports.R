...
Patristic <- function(mcmc_samples, y, x_pair, x_ind, z, spatial_dists, v, metrop_var_phi_trans, a_sigma2_epsilon_prior = NULL, b_sigma2_epsilon_prior = NULL, sigma2_regress_prior = NULL, a_sigma2_zeta_prior = NULL, b_sigma2_zeta_prior = NULL, a_tau2_prior = NULL, b_tau2_prior = NULL, a_phi_prior = NULL, b_phi_prior = NULL, sigma2_epsilon_init = NULL, beta_init = NULL, gamma_init = NULL, theta_init = NULL, sigma2_zeta_init = NULL, eta_init = NULL, tau2_init = NULL, phi_init = NULL) {
    .Call(`_GenePair_Patristic`, mcmc_samples, y, x_pair, x_ind, z, spatial_dists, v, metrop_var_phi_trans, a_sigma2_epsilon_prior, b_sigma2_epsilon_prior, sigma2_regress_prior, a_sigma2_zeta_prior, b_sigma2_zeta_prior, a_tau2_prior, b_tau2_prior, a_phi_prior, b_phi_prior, sigma2_epsilon_init, beta_init, gamma_init, theta_init, sigma2_zeta_init, eta_init, tau2_init, phi_init)
}
