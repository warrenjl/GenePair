...
```{r echo=TRUE}
results<-Patristic(mcmc_samples = 50000,
                   y = y, 
                   x_pair = x_pair, 
                   x_ind = x_ind, 
                   z = z, 
...
plot(rowMeans(results$theta[,10001:50000]),
     theta_true)
abline(0,1)

#Compare \beta
round(rowMeans(results$beta[,10001:50000]), 2)
round(beta_true, 2)

#Compare \gamma
round(rowMeans(results$gamma[,10001:50000]), 2)
round(gamma_true, 2)

#Compare \sigma2_epsilon
round(mean(results$sigma2_epsilon[10001:50000]), 2)
sigma2_epsilon_true
```