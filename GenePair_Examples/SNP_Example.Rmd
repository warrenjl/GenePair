...
r_true<-5
snp_distances<-rnbinom(n = n_star, 
                       size = r_true, 
                       prob = (1.00 - p_true))
...
[2] Apply the SNP Function within the GenePair Package:

```{r echo=TRUE}
results<-SNP(mcmc_samples = 20000,
             snp_distances = snp_distances, 
             x_pair = x_pair, 
             x_ind = x_ind, 
             z = z, 
